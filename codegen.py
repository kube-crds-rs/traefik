...
rust_lib = """//! Kubernetes CRDs for Traefik v3.0.0-rc5
//!
...
# Download https://raw.githubusercontent.com/traefik/traefik/v3.0.0-rc5/integration/fixtures/k8s/01-traefik-crd.yml and save it as traefik-crd.yml
crds = yaml.safe_load_all(
    requests.get(
        "https://raw.githubusercontent.com/traefik/traefik/v3.0.0-rc5/integration/fixtures/k8s/01-traefik-crd.yml"
    ).text
)
for crd in crds:
